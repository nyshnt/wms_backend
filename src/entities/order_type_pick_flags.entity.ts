...
import { OrderTypeRFPickValidation } from './order_type_rf_pick_validation.entity';

@ObjectType()
@Entity('order_type_pick_flags')
export class OrderTypePickFlags {
  @Field(() => OrderTypeRFPickValidation, { description: 'FK to Order Type.' })
  @PrimaryColumn({ name: 'order_type_code' })
  @ManyToOne(() => OrderTypeRFPickValidation)
  @JoinColumn({ name: 'order_type_code' })
  order_type_code: OrderTypeRFPickValidation;
  ...
  warehouse_id: OrderTypeRFPickValidation;
