...
export class Uwcs_discrete_attribute20250613111108 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      console.log('Note: Foreign keys were not created for 20250613111108-wcs_discrete_attribute.ts. You should create these foreign keys when making APIs.');
