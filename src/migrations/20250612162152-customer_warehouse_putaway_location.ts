...
export class Ucustomer_warehouse_putaway_location20250612162152 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      console.log('Note: Foreign keys were not created for 20250612162152-customer_warehouse_putaway_location.ts. You should create these foreign keys when making APIs.');
