...
export class Upick_list_rule_group20250613111232 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      console.log('Note: Foreign keys were not created for 20250613111232-pick_list_rule_group.ts. You should create these foreign keys when making APIs.');
